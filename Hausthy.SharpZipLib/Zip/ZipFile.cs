...
using Hausthy.SharpZipLib.Encryption;
using Hausthy.SharpZipLib.Core;
using Hausthy.SharpZipLib.Checksum;
using Hausthy.SharpZipLib.Zip.Compression.Streams;
using Hausthy.SharpZipLib.Zip.Compression;
using System.Collections.Generic;

namespace Hausthy.SharpZipLib.Zip
{
	...
	public class ZipFile : IEnumerable, IDisposable
	{
		...
		/// </exception>
		/// <exception cref="Hausthy.SharpZipLib.Zip.ZipException">
