...
namespace Hausthy.SharpZipLib.Checksum
{
	/// <summary>
	...
	///    checksum of zero.)"
	/// </summary>
	/// <see cref="Hausthy.SharpZipLib.Zip.Compression.Streams.InflaterInputStream"/>
	/// <see cref="Hausthy.SharpZipLib.Zip.Compression.Streams.DeflaterOutputStream"/>
